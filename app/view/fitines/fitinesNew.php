...
<div class="container middle">
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="form-group row" id="liftSel">
                <select class="col-3" id="listLifts" name="liftID[]">
            ...
            <input class="col-3" type="text" id="liftWtInput" name="liftWt[]"/>
            <input class="col-3" type="text" id="liftSetsInput" name="liftSet[]"/>
            <input class="col-2" type="text" id="liftRepsInput" name="liftRep[]"/>
