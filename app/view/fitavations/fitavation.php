...
<body>
    <div class="container middle">
        <h1 class="pageHeader">My Fitavations</h1>
        ...
        <div class="container fitavationContainer">
            <?php foreach ($fitavationArray as $fitavation) :?>
                <div class="card userFitavations">
                    ...
                    <div class="card-footer fitavationFooter">
                        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                            <div class="row justify-content-between">
                                <div class="col-2">
                                    <button class="btn deleteFitavation" id="editFitavation" name="editFitavation" type="submit">Edit</button>
                                </div>
                                <div class="col-2">
                                    <button class="btn editFitavation" id="deleteFitavation" name="deleteFitavation" type="submit">Delete</button>
                                </div>
                            </div>
                        </form>
                    </div>
